...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This policy explains how personal information is handled when people use Storvex. Storvex is a product operated by RURAXIS LTD."
    >
      <section><h2>1. Who we are</h2><p>RURAXIS LTD operates Storvex, a service that helps businesses manage sales, stock, cash, staff activity, branches, customer records, supplier records, reports, and related communications. In this policy, “Storvex,” “we,” “us,” and “our” refer to RURAXIS LTD in its operation of the Storvex product.</p><p>Questions about this policy can be sent to <a href="mailto:support@storvex.rw">support@storvex.rw</a>.</p></section>
